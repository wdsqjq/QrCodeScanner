...
import per.wsj.lib.qrcodescanner.camera.BitmapLuminanceSource;
import per.wsj.lib.qrcodescanner.camera.CameraManager;
import per.wsj.lib.qrcodescanner.decoding.DecodeFormatManager;
import per.wsj.lib.qrcodescanner.request.IRequest;
import per.wsj.lib.qrcodescanner.request.MyRequest;
    ...
    public static void analyzeBitmap(String path, ScanCallback scanCallback) {
        ...
        if (rawResult != null) {
            if (scanCallback != null) {
                scanCallback.onAnalyzeSuccess(mBitmap, rawResult.getText());
            }
        } else {
            if (scanCallback != null) {
                scanCallback.onAnalyzeFailed();
            }
        }
    }

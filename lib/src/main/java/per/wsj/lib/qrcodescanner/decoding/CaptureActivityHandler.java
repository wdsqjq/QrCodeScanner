...
package per.wsj.lib.qrcodescanner.decoding;
...
import per.wsj.lib.qrcodescanner.R;
import per.wsj.lib.qrcodescanner.ScanFragment;
import per.wsj.lib.qrcodescanner.camera.CameraManager;
import per.wsj.lib.qrcodescanner.view.ViewfinderResultPointCallback;
import per.wsj.lib.qrcodescanner.view.ViewfinderView;
...
public final class CaptureActivityHandler extends Handler {
    ...
    public CaptureActivityHandler(ScanFragment fragment, Vector<BarcodeFormat> decodeFormats,
